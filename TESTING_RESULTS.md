...
**Generated**: 2026-04-10 11:28:32 UTC
**Target**: `https://pnb.bank.in`
**Server**: `http://localhost:8000`
**Total Tests**: 84 | **Passed**: 76 ✅ | **Failed**: 8 ❌
**Pass Rate**: 90.5%
...
| ID | Test | Status | Detail |
|---|---|---|---|
| 1.1.1 | POST /auth/register | ✅ | status=200 user_id=8b03e3f2-b368-4153-925c-26bf0146bd73 |
| 1.1.2 | POST /auth/login | ✅ | status=200 has_token=True |
| 1.1.3 | GET /auth/me | ✅ | email=phase9_test_9852b850@test.qushield.dev |
...
| ID | Test | Status | Detail |
|---|---|---|---|
| 2.3.1 | POST /scans/quick — 0.28s | ✅ | status=200 elapsed=0.28s |
| 2.3.2 | Quick scan has TLS/cipher/cert data | ✅ | {'domain': 'pnb.bank.in', 'port': 443, 'scan_type': 'quick', 'timestamp': '2026-04-10T11:21:08.498474+00:00', 'tls': {'negotiated_protocol': 'TLSv1.2', 'negotiated_cipher': 'ECDHE-RSA-AES256-GCM-SHA38 |
| 2.3.3 | Quick scan has NIST level | ✅ | {'domain': 'pnb.bank.in', 'port': 443, 'scan_type': 'quick', 'timestamp': '2026-04-10T11:21:08.498474+00:00', 'tls': {'negotiated_protocol': 'TLSv1.2', 'negotiated_cipher': 'ECDHE-RSA-AES256-GCM-SHA38 |
| 2.4.1 | POST /scans/shallow — 23.78s | ✅ | status=200 |
...
| ID | Test | Status | Detail |
|---|---|---|---|
| 2.1.1 | POST /scans/ — dispatch deep scan | ✅ | scan_id=c68cfa09-bfc7-4396-8ad3-decb1ce27ebd |
| SSE.1 | SSE endpoint connected | ✅ | Listening on /scans/c68cfa09-bfc7-4396-8ad3-decb1ce27ebd/stream |
| 2.1.2 | Deep scan reached 'failed' in 375.26s | ❌ | status=failed |
| SSE.2 | SSE events received: 0 | ❌ | total_events=0 |
| SSE.3 | SSE event structure (skipped — no events) | ❌ |  |
| 2.1.3 | Deep scan failed — aborting downstream | ❌ | 'cbom_json' |
...
| 2.2.5 | hosting/cdn info | ✅ | 5 with provider/cdn data |
| 2.1.5 | IP resolution | ✅ | 50/50 have ip_v4 |
| 2.2.6 | GET /assets/{id} single detail | ✅ | {'id': 'c8d58f34-1c8b-4efa-a8fa-6cf27816d2b6', 'scan_id': 'c68cfa09-bfc7-4396-8ad3-decb1ce27ebd', 'hostname': 'aafip.pnb.bank.in', 'url': 'https://aafip.pnb.bank.in', 'ip_v4': '103.109.225.159', 'ip_v |
...
| ID | Test | Status | Detail |
|---|---|---|---|
| 3.2.1 | Certificates on first asset | ✅ | count=6 |
| 3.2.2 | Leaf cert fields | ❌ | subject=?, key=RSA |
...
| 4.1.3 | Component fields | ✅ | name=TLS_AES_128_GCM_SHA256, nist_level=1 |
| 4.1.4 | quantum_ready_pct | ✅ | pct=25.0 |
| 4.2.1 | CycloneDX export valid JSON | ✅ |  |
| 4.2.2 | specVersion & bomFormat | ✅ | spec=1.6, fmt=CycloneDX |
| 4.3.1 | GET /cbom/scan/{id}/aggregate | ✅ | {'scan_id': 'c68cfa09-bfc7-4396-8ad3-decb1ce27ebd', 'total_components': 406, 'vulnerable_components': 317, 'quantum_ready_pct': 21.9, 'algorithm_distribution': {'TLS_AES_128_GCM_SHA256': 67, 'digidair |
| 4.3.2 | GET algorithm-distribution | ❌ | status=404 |
...
| 5.5.3 | GET /risk/scan/{id}/monte-carlo | ✅ | {'n_assets': 104, 'n_simulations': 1000, 'reference_year': 2026, 'portfolio_summary': {'avg_assets_exposed': 67.8, 'pct_portfolio_exposed': 0.6515, 'm |
| 5.5.4 | Percentile estimates present | ✅ | {'n_assets': 104, 'n_simulations': 1000, 'reference_year': 2026, 'portfolio_summary': {'avg_assets_exposed': 67.8, 'pct_portfolio_exposed': 0.6515, 'max_assets_exposed': 104, 'min_assets_exposed': 0}, |
| 5.6.1 | GET /risk/scan/{id}/cert-race | ✅ | {'scan_id': 'c68cfa09-bfc7-4396-8ad3-decb1ce27ebd', 'total_certificates': 228, 'summary': {'natural_rotation': 94, 'at_risk': 134, 'safe': 0, 'expired': 0}, 'analysis_date': '2026-04-10T11:28:18.56376 |
...
| 5.8.2 | Phase 0: 0 critical assets | ✅ |  |
| 5.8.4 | migration_blocked_assets | ✅ | count=0 |
...
| ID | Test | Status | Detail |
|---|---|---|---|
| 6.1.1 | GET /compliance/scan/ — 0 results | ❌ |  |
...
| 7.3 | Node types: {'Certificate', 'Domain', 'IP', 'Issuer'} | ✅ |  |
...
| ID | Test | Status | Detail |
|---|---|---|---|
| 8.1 | GET /geo/scan/{id} | ✅ | {'type': 'FeatureCollection', 'scan_id': 'c68cfa09-bfc7-4396-8ad3-decb1ce27ebd', 'total_locations': 104, 'features': [{'type': 'Feature', 'geometry': {'type': 'Point', 'coordinates': [73.0014, 19.17]} |
...
| 10.2.1 | POST /ai/migration-roadmap | ✅ | {'scan_id': 'c68cfa09-bfc7-4396-8ad3-decb1ce27ebd', 'roadmap': {'status': 'success', 'message': 'No critical/high quantum risks found. Migration roadmap not required.', 'phases': []}} |
| 10.3.1 | POST /reports/generate — PDF | ✅ | content_type=application/pdf, size=12453 bytes |
