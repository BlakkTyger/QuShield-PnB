...
export default function TopologyPage() {
  ...
  useEffect(() => {
    ...
    const simulation = d3
      ...
      .force("link", d3.forceLink(links).id((d: unknown) => (d as SimNode).id).distance(80))
    ...
    node.each(function (d) {
      ...
      const r = d.type === "certificate" || d.type === "issuer" ? 10 : 8;
    ...
    // Node labels (only for larger screens)
    node
      .append("text")
      .attr("dy", 20)
    ...
    node
      .on("mouseenter", function () {
        d3.select(this).select("circle, rect, polygon").attr("opacity", 1);
      })
      .on("mouseleave", function () {
        d3.select(this).select("circle, rect, polygon").attr("opacity", 0.85);
      });
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <span
                      ...
                      style={{ background: NODE_TYPE_COLORS[selectedNode.type] || "#888" }}
                    />
