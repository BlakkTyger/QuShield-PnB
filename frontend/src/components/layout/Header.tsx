    ...
    >
      <div className="flex items-center gap-4 flex-1">
        ...
        <div>
          ...
          <p className="text-[11px]" style={{ color: "var(--header-text-muted)" }}>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="flex flex-col items-end">
            <span className="text-sm font-medium" style={{ color: "var(--header-text-primary)" }}>
              {user?.email || "Loading..."}
            </span>
          ...
          <div
            ...
            style={{ background: "rgba(255, 255, 255, 0.1)", border: "1px solid rgba(255, 255, 255, 0.2)", color: "var(--header-text-secondary)" }}
          >
            <UserIcon size={16} />
          </div>
          ...
          <button
            ...
            className="ml-2 p-2 rounded-lg transition-colors flex items-center gap-1 text-xs font-semibold hover:bg-red-500/10 hover:text-red-400"
            style={{ color: "var(--header-text-secondary)" }}
            title="Log Out"
          >
            <LogOut size={16} />
