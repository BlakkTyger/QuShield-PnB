...
def clone_scan_data(
    ...
    if source_compliance:
        new_comp_result = ComplianceResult(
            scan_id=target_scan_id,
            asset_id=target_asset_id,
            overall_compliance_pct=source_compliance.overall_compliance_pct,
            tls_13_enforced=source_compliance.tls_13_enforced,
            forward_secrecy=source_compliance.forward_secrecy,
            fips_203_compliant=source_compliance.fips_203_compliant,
            fips_204_compliant=source_compliance.fips_204_compliant,
            fips_205_compliant=source_compliance.fips_205_compliant,
            pci_dss_compliant=source_compliance.pci_dss_compliant,
