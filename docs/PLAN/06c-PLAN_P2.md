...
- [x] Create `backend/app/services/crypto_inspector.py` — start with a single function:
...
- [x] Create `backend/tests/standalone/test_tls_scan.py`:
...
- [x] Add function to `crypto_inspector.py`:
...
- [x] Add function `parse_certificate_chain(chain_pems: list[bytes]) -> list[dict]`:
...
- [x] Create `backend/tests/standalone/test_cert_parse.py`:
...
- [x] Create `backend/tests/standalone/test_quantum_level.py`:
...
- [x] Create `backend/tests/standalone/test_pqc_detect.py`:
...
- [x] Create `backend/tests/standalone/test_api_auth.py`:
...
- [x] Add function `inspect_assets_batch(assets: list[dict], max_concurrent: int = 20) -> list[CryptoFingerprint]`:
...
- [x] Create `backend/tests/standalone/test_full_crypto.py`:
...
- [x] Add test to `tests/standalone/test_full_crypto.py`:
